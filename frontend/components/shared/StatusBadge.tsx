const CONFIG: Record<string, { label: string; dot: string; text: string; bg: string; border: string }> = {
  UPLOADED:          { label: "Uploaded",         dot: "bg-slate-400",  text: "text-slate-300",  bg: "bg-muted", border: "border-white/10" },
  ...
  PENDING:           { label: "Pending",          dot: "bg-slate-500",  text: "text-slate-400",  bg: "bg-muted", border: "border-white/10" },
  ...
  DISMISSED:         { label: "Dismissed",        dot: "bg-slate-600",  text: "text-slate-500",  bg: "bg-muted", border: "border-white/[0.06]" },
  ...
  INCOMPLETE:   { label: "Incomplete",    dot: "bg-slate-500",  text: "text-slate-400",  bg: "bg-muted", border: "border-white/10" },
  ...
  not_executed: { label: "Not Executed", dot: "bg-slate-400", text: "text-slate-300", bg: "bg-muted", border: "border-white/10" },
  not_applicable: { label: "Not Applicable", dot: "bg-slate-400", text: "text-slate-300", bg: "bg-muted", border: "border-white/10" },
  MANUAL_PASS: { label: "Passed", dot: "bg-green-400", text: "text-green-200", bg: "bg-green-950/40", border: "border-green-500/25" },
};

const FALLBACK = { label: "", dot: "bg-slate-400", text: "text-slate-400", bg: "bg-muted", border: "border-white/10" };
