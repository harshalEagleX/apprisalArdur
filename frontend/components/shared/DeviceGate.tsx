  ...
  if (width < minWidth) {
    return (
      <main className="foundation-grid relative min-h-screen overflow-hidden bg-slate-950 px-5 py-8 text-white">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_25%,rgba(226,232,240,0.04),transparent_34%),linear-gradient(to_bottom,rgba(5,7,10,0.62),rgba(5,7,10,0.86)_78%)]" />
        <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-sm flex-col justify-center">
          <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-lg border border-slate-500/25 bg-slate-950/35 shadow-[0_0_28px_rgba(226,232,240,0.16)]">
            {allowTablet ? <Tablet size={22} className="text-slate-300" /> : <Monitor size={22} className="text-slate-300" />}
          </div>
