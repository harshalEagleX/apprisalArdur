...
const COLORS = {
  blue:   "text-blue-200   bg-blue-950/30   border-blue-500/25",
  ...
  indigo: "text-blue-200   bg-blue-950/30   border-blue-500/25",
...
export default function StatCard({ label, value, icon: Icon, color = "slate", loading }: StatCardProps) {
  ...
  return (
    <div className={`rounded-lg border p-4 shadow-[0_12px_32px_rgba(0,0,0,0.18)] ${c}`}>
