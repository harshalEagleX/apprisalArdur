          ...
          <Card title="Notification preferences" icon={Bell}>
            ...
            <div className="space-y-3">
              {[
                ...
                <label key={item.key} className="flex cursor-pointer items-center gap-4 rounded-lg border border-white/[0.06] bg-sunken/50 px-4 py-3.5 transition hover:border-white/10">
                  <input type="checkbox" defaultChecked className="h-4 w-4 rounded border-white/20 bg-surface accent-indigo-500" />
