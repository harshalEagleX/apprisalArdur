...
const ROLE_STYLES: Record<string, string> = {
  ADMIN:    "bg-blue-950/40 border-blue-500/25 text-blue-200",
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center justify-end gap-1">
                    <button
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-md text-slate-400 transition-colors hover:bg-white/[0.04] hover:text-blue-300"
...
function RoleSummary({ icon: Icon, label, value, tone }: {
  ...
  const styles = tone === "blue"
    ? "border-blue-500/25 bg-blue-950/30 text-blue-200"
