...
import com.apprisal.entity.QCResult;
import com.apprisal.repository.QCResultRepository;
import com.apprisal.service.PythonClientService;
import com.apprisal.service.QCProcessingService;
import com.apprisal.service.QCProcessingService.QCProcessingSummary;
...
@Tag(name = "QC API", description = "Operations for triggering and interacting with the Python OCR/QC quality system")
public class QCApiController {
     ...
     */
    @Operation(summary = "Trigger QC processing", description = "Requests the Python service to process the batch files for QC")
     ...
     */
    @Operation(summary = "Get batch QC results", description = "Retrieves array of all QC check outcomes for a specific batch")
     ...
     */
    @Operation(summary = "Get file QC results", description = "Retrieves QC details for an individual file")
     ...
     * GET /api/qc/health
     */
    @Operation(summary = "Check Python QC health", description = "Checks whether the python-based QC worker is alive and reachable")
    @GetMapping("/health")
     ...
     * GET /api/qc/rules
     */
    @Operation(summary = "Get available QC rules", description = "Retrieves the dynamic list of rules provided by the python worker")
    @GetMapping("/rules")
