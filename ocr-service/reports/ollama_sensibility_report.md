...
Generated: 2026-05-14 18:31 UTC  |  Model: llava:13b  |  Provider: Ollama (local)

## Overview

| Batch | Label | Total Time | Pages | Rules Run | PASS | FAIL | VERIFY | Ollama Doc Extract |
|---|---|---|---|---|---|---|---|---|
| MSL | MSL (reference — used to build regex/rules) | 392s | 27 | 137 | 63 | 3 | 47 | addr: `—` |
| 2321525470 | #2321525470 (random/unknown — cross-format validation) | 504s | 30 | 137 | 54 | 7 | 57 | addr: `—` |
...
Total Ollama enrichment time: **0.0s**  |  Total pipeline time: **392s**
...
Total Ollama enrichment time: **0.0s**  |  Total pipeline time: **504s**
...
*Report generated by scripts/run_ollama_batch.py at 2026-05-14 18:31 UTC*
