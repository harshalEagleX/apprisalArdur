...
RULE_DEFAULTS = [
    ...
    # ── Commentary/Narrative rules — run last (may call LLM) ─────────────────
    ("N-1",  "Narrative", "ADVISORY", 210, "ALL"),
    ("N-2",  "Narrative", "STANDARD", 220, "ALL"),
    ("N-3",  "Narrative", "ADVISORY", 230, "ALL"),
    ("N-4",  "Narrative", "ADVISORY", 240, "ALL"),
    ("N-5",  "Narrative", "STANDARD", 250, "ALL"),
    ("N-6",  "Narrative", "ADVISORY", 260, "ALL"),
    ("N-7",  "Narrative", "STANDARD", 270, "ALL"),
]
