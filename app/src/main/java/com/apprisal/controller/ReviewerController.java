...
public class ReviewerController {
    ...
    public String dashboard(Model model, @AuthenticationPrincipal UserPrincipal principal) {
        ...
        model.addAttribute("recentActivity", auditLogService.findByUserId(user.getId()));
    ...
    public String submitVerification(@PathVariable @NonNull Long qcResultId,
        ...
        try {
            ...
            auditLogService.logEntity(user, "QC_VERIFIED", "QCResult", qcResultId);
    ...
    public String acceptAll(@PathVariable @NonNull Long qcResultId,
        ...
        try {
            ...
            auditLogService.logEntity(user, "QC_ACCEPTED_ALL", "QCResult", qcResultId);
    ...
    public String rejectAll(@PathVariable @NonNull Long qcResultId,
        ...
        try {
            ...
            auditLogService.logEntity(user, "QC_REJECTED", "QCResult", qcResultId);
    ...
    public String startReview(@PathVariable Long id,
        ...
        try {
            ...
            auditLogService.logEntity(user, "REVIEW_STARTED", "Batch", id);
    ...
    public String completeReview(@PathVariable Long id,
        ...
        try {
            ...
            auditLogService.logEntity(user, "REVIEW_COMPLETED", "Batch", id);
